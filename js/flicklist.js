...
var api = {
  ...
  token: "removed for git repo", // TODO 0 add your api key
  ...
  posterUrl: function(movie) {
    ...
    var post_root = "http://image.tmdb.org/t/p/w300/";


    return post_root + movie.poster_path;
  }
}
...
function render() {
  ...
  model.watchlistItems.forEach(function(movie) {
    var title = $("<h6></h6>").text(movie.original_title).attr("class", "panel-heading");
